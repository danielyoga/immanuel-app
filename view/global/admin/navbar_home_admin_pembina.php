...
<div class="container-fluid">
    <!-- <div class="navbar-fixed"> -->
        ...
        <div class="nav-wrapper" style="background-color: #001D39;">
            <!-- Home Button Trigger -->
            <a href="../03-home/03-home.html" class="sidenav-trigger"><i class="material-icons">home</i></a>
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="#alasanketidakhadiran">Alasan Ketidakhadiran</a></li>
                <li><a href="Sarankritik">Saran & Kritik</a></li>
